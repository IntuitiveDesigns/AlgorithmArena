...
public class ArenaProducer {
    private static final Logger log = LoggerFactory.getLogger(ArenaProducer.class);
    private static final String PROPERTIES_FILE = "producer.properties";
    private final KafkaProducer<String, String> producer;

    public ArenaProducer() {
    ...
    public static void main(String[] args) {
        System.out.println("⚔️ Connecting to Arena NVMe Broker...");

        ArenaProducer arenaProducer = new ArenaProducer();

        // Send 10 test messages
        for (int i = 0; i < 10; i++) {
            arenaProducer.sendMessage("arena-test-topic", "id-" + i, "Algorithm Benchmark Result #" + i);
        }
